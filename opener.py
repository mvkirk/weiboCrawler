...
def getOpener():
	#proxy_handler = urllib2.ProxyHandler({"http" : 'http://114.36.99.150:8080'})
	#opener=urllib2.build_opener(proxy_handler)
	opener=urllib2.build_opener()
        opener.addheaders=[('User-agent',random.choice(ua)),("X-Requested-With","XMLHttpRequest"),('Upgrade-Insecure-Requests',1)]
	return opener
